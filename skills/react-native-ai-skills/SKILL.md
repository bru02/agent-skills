...
description: Provides integration recipes for the React Native AI @react-native-ai package and its providers (llama, apple, mlc, ncnn-wrapper). Use when integrating local on-device AI in React Native, setting up providers, model management.
license: MIT
metadata:
  author: Callstack
